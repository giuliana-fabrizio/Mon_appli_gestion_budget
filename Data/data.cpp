...
std::vector<std::string> Data::depenses_fixes_predefinies = {"Assurance logement", "Logement (charge - crédit ou\nlocation)", "Impot sur le revenu", "Assurance auto", "Transports", "Tel. mobile", "Internet"};
